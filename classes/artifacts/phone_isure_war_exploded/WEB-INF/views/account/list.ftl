...
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                            ...
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="[@spring.url '/account/update_appKey/${account.id}'/]"
                                        ...
                                        [/#if]
                                        <a data="[@spring.url '/account/delete/${account.id}'/]" class="del-account"
                                           data-toggle="tooltip" data-placement="top" title="点击删除账号">
                                            <span class="label label-success">刪除账号</span>
                                        </a>
                                    </td>
                                </tr>
                                [/#list]
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/account/pagination?userName=${command.userName!}&appKey=${command.appKey!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
