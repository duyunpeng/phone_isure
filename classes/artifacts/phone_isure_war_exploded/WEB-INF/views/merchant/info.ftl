...
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <li><a href="/merchant/pagination">用户管理</a></li>
    <li>用户查看</li>
</ul>
[/@override]
    ...
    <div class="col-lg-12">
        <ul class="contract-show">
            ...
            <li>
                ...
                <div class="col-md-8 contract-box">[@mc.dateShow merchant.createDate/]</div>
            </li>
            <li>
            ...
            <li>
                ...
                <div class="col-md-8 contract-box">${merchant.appKey.name!}</div>
            </li>
            <li>
            ...
            <div>
                <div class="col-sm-offset-6 col-sm-12">
                    <a href="[@spring.url '/merchant/create' /]" class="btn btn-success">再创建一个</a>
                    <a href="[@spring.url '/merchant/pagination' /]" class="btn btn-default">返回列表</a>
                </div>
            </div>
        </ul>
    </div>
