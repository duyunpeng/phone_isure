[@override name="title"]待审核代理管理 - 代理查看[/@override]
...
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <li><a href="/merchant/pagination">待审核代理管理</a></li>
    <li>待审核代理查看</li>
</ul>
[/@override]
        ...
        <ul class="contract-show">
            ...
            <div>
                <div class="col-sm-offset-6 col-sm-12">
                    <a href="[@spring.url '/merchant/wait_agency_pagination' /]" class="btn btn-default">返回列表</a>
                </div>
            </div>
        </ul>
    </div>
