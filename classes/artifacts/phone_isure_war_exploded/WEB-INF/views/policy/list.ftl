...
<div class="smart-widget widget-dark-blue">
    <div class="smart-widget-header">
        ...
        <div class="row margin-sm">
            <form class="form-inline no-margin" role="form">
                ...
                <div class="form-group">
                    <label for="agent" class="control-label">代理</label>
                    <input type="text" class="form-control" id="agent" name="agent" value="${command.agent!}"
                           placeholder="代理"/>
                </div>
                <div class="form-group">
        ...
        <div class="row margin-sm">
            <form class="form-inline no-margin" action="/policy/export_excel" role="form">
                ...
                <div class="form-group">
                    <label fro="agentUserName" class="control-label">代理账号</label>
                    <input type="text" name="agentUserName" value="${command.agentUserName!}" class="form-control"
                           placeholder="代理账号">
                </div>
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        [#if policy.policyStatus == "BACK"]
                                            <a href="[@spring.url '/policy/update_policyStatus?id=${policy.id!}&version=${policy.version!}'/]"
                                        ...
                                        [#if policy.policyStatus == "NORMAL"]
                                            ...
                                            <a href="javascript:void(0)" class="return-policy"
                                               data-id="${policy.id!}" data-version="${policy.version}"
                                               data-toggle="tooltip" data-placement="top" title="点击退单">
                                                <span class="label label-danger">退单</span>
                                            </a>
                                        [/#if]
                                        ...
                                        [@shiro.hasRole name="admin"]
                                            <a href="[@spring.url '/policy/update_pic/${policy.id!}'/]"
                                               data-toggle="tooltip" data-placement="top" title="点击修改理赔照片"
                                            <span class="label label-success">修改照片</span>
                                            </a>
                                        [/@shiro.hasRole]
                                    </td>
                                </tr>
            ...
            <div class="bg-grey">
                [#if pagination!]
             [@mc.showPagination '/policy/pagination?merchant=${command.merchant!}&policyNo=${command.policyNo}&insuredName=${command.insuredName!}&IMEI=${command.IMEI!}&beginTime=${command.beginTime!}&endTime=${command.endTime}&policyStatus${command.policyStatus}' /]
        [/#if]
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(".return-policy").on("click", function () {
        if (confirm("是否退单?")) {
            window.location.href = "/policy/return_policy?id=" + $(this).attr("data-id") + "&version=" + $(this).attr("data-version");
        } else {
            return;
        }
    })
