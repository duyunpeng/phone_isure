[@override name="title"]待审核商户管理 - 待审核商户查看[/@override]
...
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <li><a href="/merchant/merchant_wait_pagination">待审核商户管理</a></li>
    <li>待审核商户查看</li>
</ul>
[/@override]
        ...
        <ul class="contract-show">
            ...
            <div>
                <div class="col-sm-offset-6 col-sm-12">
                    <a href="[@spring.url '/merchant/merchant_wait_pagination' /]" class="btn btn-default">返回列表</a>
                </div>
            </div>
        </ul>
    </div>
