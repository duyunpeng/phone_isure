...
<div class="row margin-md">
    <a href="/account/create" class="btn btn-md btn-success">新增用户</a>
</div>
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/merchant/pagination?userName=${command.userName!}&appKey=${command.appKey!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
