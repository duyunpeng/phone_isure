[@override name="title"]手机品牌管理[/@override]
...
<div class="row margin-md">
    <a href="/phone_brand/create" class="btn btn-md btn-success">新增品牌</a>
</div>
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            <div class="padding-md">
                <section class="overflow-auto nice-scrollbar">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                [#list pagination.data as phoneBrand ]
                                <tr>
                                    <td>${phoneBrand.name!}</td>
                                    <td>${phoneBrand.sort!}</td>
                                    <td>${(phoneBrand.status.getName())!}</td>
                                    <td>
                                        <a href="[@spring.url '/phone_brand/info/${phoneBrand.id!}'/]"
                                           data-toggle="tooltip" data-placement="top" title="点击查看详情">
                                            <span class="label label-info">查看</span>
                                        </a>
                                        <a href="[@spring.url '/phone_brand/edit/${phoneBrand.id!}'/]"
                                           data-toggle="tooltip" data-placement="top" title="点击修改信息">
                                            <span class="label label-success">修改</span>
                                        </a>
                                        [#if phoneBrand.status == "ENABLE"]
                                            <a href="[@spring.url '/phone_brand/update_status?id=${phoneBrand.id!}&version=${phoneBrand.version!}'/]"
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/phone_brand/pagination?name=${command.name!}&status=${command.status!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
