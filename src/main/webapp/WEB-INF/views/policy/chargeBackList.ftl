...
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
             [@mc.showPagination '/policy/charge_back_pagination?merchant=${command.merchant!}&policyNo=${command.policyNo}&insuredName=${command.insuredName!}&IMEI=${command.IMEI!}&beginTime=${command.beginTime!}&endTime=${command.endTime}' /]
        [/#if]
            </div>
        </div>
