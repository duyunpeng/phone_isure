...
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="[@spring.url '/policy/external/${policy.id!}'/]"
            ...
            <div class="bg-grey">
                [#if pagination!]
             [@mc.showPagination '/policy/external_pagination?policyNo=${command.policyNo}&beginTime=${command.beginTime!}&endTime=${command.endTime}&policyStatus${command.policyStatus}' /]
        [/#if]
            </div>
        </div>
