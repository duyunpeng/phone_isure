[@override name="title"]保单管理 - 修改保单图片[/@override]
...
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <li><a href="[@spring.url '/policy/pagination'/]">保单管理</a></li>
    <li>修改保单图片</li>
</ul>
[/@override]
...
<div class="row">
    <div class="col-lg-8">
        <form class="form-horizontal" action="/policy/update_pic" method="post" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="policyNo" name="policyNo"
                           value="${policy.policyNo!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="merchant" name="merchant"
                           value="${policy.merchant.userName!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="policyFee" name="policyFee"
                           value="${policy.policyFee!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="insuredName" name="insuredName"
                           value="${policy.insuredName!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="insuredPhone" name="insuredPhone"
                           value="${policy.insuredPhone!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="idType" name="idType"
                           value="${policy.idType.getName()!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="idNumber" name="idNumber"
                           value="${policy.idNumber!}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="insuredBeginDate" name="insuredBeginDate"
                           value="[@mc.dateShow policy.insuredBeginDate!/]" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="policyStatus" name="policyStatus"
                           value="${policy.policyStatus.getName()!}" disabled/>
                </div>
            </div>

            <div class="form-group">
                <label for="agent" class="col-md-3 control-label">理赔照片</label>
                <div class="col-md-9">
                    <button type="button" class="btn btn-sm btn-primary img-upload">点击添加图片</button>
                    <ul class="img-box">
                        [#list policy.insuredAfterPicture as price]
                            <li>
                                <img src="${price.picPath!}"/>
                                <input type="hidden" value="${price.picPath!}" name="pics"/>
                                <div>
                                    <a href="#" class="btn-sm btn-danger del-img">删除</a>
                                </div>
                            </li>
                        [/#list]
                    </ul>
...
//                alert(src);
    ...
    uploader.on('uploadSuccess', function (file, result) {
        ...
        var $ul = $(".img-box");
        $ul.append('<li><img src=' + url + '/><input type="hidden" value=' + url + ' name="pics"/><div><a href="#" class="btn-sm btn-danger del-img">删除</a></div></li>');
    });
